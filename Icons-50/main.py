...
def parse_args():
    ...
    parser.add_argument('--test_style', type=str, default='microsoft')
    ...
    parser.add_argument(
        ...
        type=str,
        default='Icons',
        choices=['Icons', 'CIFAR10', 'CIFAR100', 'MNIST', 'FashionMNIST'])
...
def test(epoch, model, criterion, test_loader, run_config, writer):
    ...
    logger.info('Epoch {} Test Loss {:.3f} Test Acc {:.4f}'.format(
